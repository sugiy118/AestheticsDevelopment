...
import UIKit
    ...
    class ProblemListTableView3: UITableView, UITableViewDelegate, UITableViewDataSource {
        ...
        func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            if indexPath.section == 0 {
                ...
                cell.quizName.text = questionManager.question.sentence3
                ...
                cell.answer1Label.text = answerManager.answer.answer1_question3
                cell.answer2Label.text = answerManager.answer.answer2_question3
                cell.answer3Label.text = answerManager.answer.answer3_question3
                cell.answer4Label.text = answerManager.answer.answer4_question3
