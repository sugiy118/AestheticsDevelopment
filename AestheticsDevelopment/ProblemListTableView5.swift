...
class ProblemListTableView5: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.quizName.text = questionManager.question.sentence5
            ...
            cell.answer1Label.text = answerManager.answer.answer1_question5
            cell.answer2Label.text = answerManager.answer.answer2_question5
            cell.answer3Label.text = answerManager.answer.answer3_question5
            cell.answer4Label.text = answerManager.answer.answer4_question5
